...
function buildRpcConfig() {
    ...
    const functionContent = `// Auto-generated RPC configuration for Netlify Functions - DO NOT EDIT MANUALLY
...
// Also create a TypeScript module version for better integration
const tsConfigPath = path.join(__dirname, '../lib/rpc-config.ts');
const tsContent = `// Auto-generated RPC configuration - DO NOT EDIT MANUALLY
    // Generated at build time: ${config.buildTime}

    export const rpcConfig = ${ JSON.stringify(config, null, 2)
} as const ;
