...
import { generateSecureAuthToken } from '@/lib/api-auth/crypto-utils';
...
export class EventStreamManager {
    ...
    private async startMonitoring(): Promise<void> {
        ...
        try {
            console.log('EventStreamManager: Starting monitoring...');
            ...
            console.log('EventStreamManager: Connection established');
            ...
            if (hasBlockListeners) {
                await this.safeSubscribe('slots', () => {
                    const slotCallback = (slotInfo: any) => {
                        ...
                        return 0; // Return dummy subscription ID since we don't use it for slots
                    };
