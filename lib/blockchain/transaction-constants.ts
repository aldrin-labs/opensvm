...
export const TRANSACTION_BATCH_SIZE = 1000; // Aggressive batching (standard is 100)
...
export const MAX_CONCURRENT_BATCHES = 25; // Reduced from 50 to 5 to balance large batch size
