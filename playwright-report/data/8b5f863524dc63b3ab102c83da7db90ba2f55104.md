...
```yaml
- alert: OpenSVM - AI Explorer and RPC nodes provider for all SVM networks (Solana Virtual Machine)
...
- main:
  ...
  - tablist "Analytics navigation tabs":
    ...
    - tab "Validators tab - Validator performance and decentralization analytics" [selected]: Validators
